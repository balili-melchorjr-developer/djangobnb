    ...
    return (
        <div className="pt-4 cursor-pointer pb-6 flex items-center space-x-12">
            <div 
                ...
                <Image src="/icon-category.jpg" alt="Category - All" width={20} height={20}/>
            ...
            <div 
                ...
                <Image src="/icon-category.jpg" alt="Category - Beach" width={20} height={20}/>
            ...
            <div 
                ...
                <Image src="/icon-category.jpg" alt="Category - Villas" width={20} height={20}/>
            ...
            <div 
                ...
                <Image src="/icon-category.jpg" alt="Category - Cabins" width={20} height={20}/>
            ...
            <div
                ...
                <Image src="/icon-category.jpg" alt="Category - Tiny Homes" width={20} height={20}/>
